...
access_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..bxW3Rdd4RyPHYAPxjBDVRaRkXSlItXTgDNOzPlsifWs'
# ===================================================================================
# Setup Related Configs
# ===================================================================================
ORB_timeFrame = 60  # in seconds
symbols = ['NSE:BANKNIFTY2422146500CE', 'NSE:BANKNIFTY2422146300PE']
symbol_1 = symbols[0]
symbol_2 = symbols[1]
